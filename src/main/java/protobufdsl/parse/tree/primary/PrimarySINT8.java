 ...
 * @version Feb 21, 2014 6:15:22 PM
 * 
 */
public class PrimarySINT8 extends Primary implements Countable {

    public static final String name = "SINT8";

    @Override
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) throws AstVisitingException {
        return visitor.visitPrimarySINT8(this, context);
    }
