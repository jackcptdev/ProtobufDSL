 ...
 * @version Feb 21, 2014 6:14:25 PM
 * 
 */
public class PrimarySINT16 extends Primary implements Countable {

    public static final String name = "SINT16";

    @Override
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) throws AstVisitingException {
        return visitor.visitPrimarySINT16(this, context);
    }
