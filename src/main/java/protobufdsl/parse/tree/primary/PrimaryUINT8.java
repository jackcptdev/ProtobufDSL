 ...
 * @version Feb 21, 2014 6:19:16 PM
 * 
 */
public class PrimaryUINT8 extends Primary implements Countable {

    public static final String name = "UINT8";

    @Override
    public <R, C> R accept(AstVisitor<R, C> visitor, C context) throws AstVisitingException {
        return visitor.visitPrimaryUINT8(this, context);
    }
